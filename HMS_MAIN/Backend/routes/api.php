...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('payments')->group(function () {
        ...
        Route::post('/student', [PaymentController::class, 'createStudentPayment']);
        
        // Create salary payment for staff
        Route::post('/salary', [PaymentController::class, 'createSalaryPayment']);
        ...
        Route::post('/{id}/resend-email', [PaymentController::class, 'resendEmail']);
        
        // Get student payment history
        Route::get('/student/{studentId}/history', [PaymentController::class, 'studentPaymentHistory']);
