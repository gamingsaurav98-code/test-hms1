        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span>Rs. <?php echo e(number_format($record->staff->salary_amount ?? 0, 2)); ?></span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span>Rs. <?php echo e(number_format($record->adjusted_amount ?? ($record->staff->salary_amount ?? 0), 2)); ?></span>
                </div>
                <div class="detail-row">
...
</html><?php /**PATH /var/www/html/resources/views/emails/staff_checkin_checkout_approved.blade.php ENDPATH**/ ?>