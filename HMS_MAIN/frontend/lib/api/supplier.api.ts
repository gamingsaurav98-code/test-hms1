...
export const supplierApi = {
  ...
  async uploadAttachment(id: string, file: File, name: string, type: string): Promise<any> {
    ...
    const response = await apiFetch(`${API_BASE_URL}/suppliers/${id}/attachment`, {
      method: 'POST',
      headers: {
        ...getAuthHeaders(),
      },
  ...
  async updateAttachment(supplierId: string, attachmentId: string, data: {file?: File, name?: string, type?: string}): Promise<any> {
    ...
    const response = await apiFetch(`${API_BASE_URL}/suppliers/${supplierId}/attachment/${attachmentId}`, {
      method: 'POST',
      headers: {
        ...getAuthHeaders(),
      },
