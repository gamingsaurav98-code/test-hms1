...
export default function Structure({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-between h-full px-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="text-lg font-semibold text-gray-900">
              HMS | <span className="text-gray-600">Gaud Boys Hostel</span>
            </div>
          ...
          <div className="flex items-center space-x-6">
            <div className="hidden md:flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>Tue, Jun 24, 2025, 04:06 PM</span>
            </div>
      ...
      {/* Sidebar */}
      <div className="fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] bg-gray-900 overflow-y-auto z-20">
        <div className="p-4">
          <nav className="space-y-1">
            {/* Dashboard */}
            <div className="bg-blue-600 rounded-lg">
              <a href="#" className="flex items-center px-4 py-3 text-white">
