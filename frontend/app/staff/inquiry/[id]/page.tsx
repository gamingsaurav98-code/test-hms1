...
export default function StaffInquiryDetails({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchInquiry = async () => {
      try {
        ...
        const data = await staffInquiryApi.getInquiry(id);
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <Button
                onClick={() => router.push(`/staff/inquiry/${id}/edit`)}
                variant="primary"
              >
                Edit Inquiry
              </Button>
