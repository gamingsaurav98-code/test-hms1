@echo off
REM Student Seeder Runner Script for Windows
REM This script runs the student seeder with all dependencies
...
REM Run the complete student seeder (includes blocks and rooms)
